...
var Basic1 = function () {
    ...
    function BuildNormalTransformation(linearTransf) {
        ...
        var linearTransf_det = (linearTransf.A[0]*linearTransf.A[3]) - (linearTransf.A[1]*linearTransf.A[2]); 
        var linearTransf_inv = [linearTransf.A[3],-linearTransf.A[1],-linearTransf.A[2],linearTransf.A[0]];
	linearTransf_inv.map(function(x) x/linearTransf_det);
	var linearTransf_trans = [linearTransf_inv[0],linearTransf_inv[2],linearTransf_inv[1],linearTransf_inv[3]];
	return new LinearTransformation(linearTransf_trans);
   
        /*var linearTransf_inv = mat2.fromValues(linearTransf.A[0],linearTransf.A[1],linearTransf.A[2],linearTransf.A[3]);
        var temp = mat2.create();
        mat2.invert(temp,linearTransf_inv);
        console.log(temp);
        var temp_1 = mat2.create;
        mat2.transpose(temp_1,temp);
        var result = */
